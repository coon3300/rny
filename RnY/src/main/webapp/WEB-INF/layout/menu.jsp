...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch"
    ...
    <div class="offcanvas-body">
      ...
      <div class="order-md-last">
        ...
        <!-- search-form2 -->
          <form id="search-form2" class="text-center d-flex align-items-center" action="" method="">
    ...
    <div class="container py-2">
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
          ...
          <!-- search-form1 -->
            <form id="search-form1" class="text-center d-flex align-items-center" action="" method="">
        ...
        <div class="d-flex d-lg-none align-items-end mt-3">
          <ul class="d-flex justify-content-end list-unstyled m-0">
            ...
            <!-- 
              <a href="#" class="mx-3">
             -->
	          	<a class="mx-3" href="loginForm.do" data-bs-toggle="modal" data-bs-target="#loginModal">
          ...
          <div class="offcanvas-body justify-content-between ">
            ...
            <div class="d-none d-lg-flex align-items-end">
              <ul class="d-flex justify-content-end list-unstyled m-0">
                ...
                <li class="">
                  <a href="#" class="nav-link mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                    aria-controls="offcanvasCart">
                    <iconify-icon icon="mdi:cart" class="fs-4 position-relative"></iconify-icon>
                    <span class="position-absolute translate-middle badge rounded-circle bg-primary pt-2">
      ...
      <div class="modal-body">
			  <form action="login.do">
			    ...
			    <div class="form-floating">
			      <input type="text" class="form-control" id="floatingInput" placeholder="아이디를 입력하세요." name="id">
			      <label for="floatingInput">아이디</label>
			    </div>
			    <div class="form-floating">
			      <input type="password" class="form-control" id="floatingPassword" placeholder="비밀번호를 입력하세요." name="pw">
