			...
			<div class="row">
				...
				<div class="col-md-6 mb-5 mb-md-0">
					...
					<div class="p-3 p-lg-5 border bg-white">
						<form action="buyAdd.do" method="post">
						
						<c:forEach var="buy" items="${buyList}" varStatus="status" begin="0" end="0">
							...
							<div class="form-group row">
								<div class="col-md-12">
									...
									onclick="sample6_execDaumPostcode()" required value="${buy.userAdd}"> 
							...
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderPhone" class="text-black">전화번호<span
										...
										onkeypress="return checkNumber(event)" required value="${buy.userPhone}">
								</div>
							</div>
							<br>
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderEmail" class="text-black">이메일<span
										...
										placeholder="" required value="${buy.userEmail}">
								</div>
							</div>
							...
							<tbody>
								...
								<c:forEach var="item" items="${buyList}">
									<tr>
										...
										<td>${item.itemCnt}</td>
										<td>${item.itemPrice * item.itemCnt}</td>
									</tr>
								</c:forEach>
								<tr>
									...
									<td class="text-black font-weight-bold"></td>
									<c:forEach var="buy" items="${buyList}" varStatus="status" begin="0" end="0">
									<td class="text-black font-weight-bold"><strong><fmt:formatNumber value="${buy.basketTotalPrice}" pattern="#,###" />원</strong></td>
									</c:forEach>
								</tr>
							</tbody>
						</table>
