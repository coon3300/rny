	...
	<div class="untree_co-section">
		<div class="container">
			<h1 class="h1 mb-3 text-black">
				<a href="buyList.do"> <svg xmlns="http://www.w3.org/2000/svg"
			...
			<div class="row">
				...
				<div class="col-md-6 mb-5 mb-md-0">
					...
					<div class="p-3 p-lg-5 border bg-white">
						...
						<c:forEach var="buy" items="${buyListDetail}" varStatus="status" begin="0" end="0">
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderName" class="text-black">받는사람<span
										class="text-danger">*</span></label> <input type="text"
										class="form-control" id="orderName" name="orderName"
										placeholder="${logName}" required disabled>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderAdd" class="text-black">주소
										<span	class="text-danger">*</span>
									</label> 
									<input type="text" class="form-control" id="sample6_postcode"	placeholder="우편번호 찾기" 
									onclick="sample6_execDaumPostcode()" required value="${buy.userAdd}" disabled> 
									<input type="text" class="form-control"	id="sample6_address" name="orderAdd" placeholder="주소" 
									required value="1층" disabled>
									<input type="text" class="form-control"	id="sample6_extraAddress" name="orderExtraAdd"
										placeholder="상세주소" value="101호" disabled> 
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderPhone" class="text-black">전화번호<span
										...
										onkeypress="return checkNumber(event)" required value="${buy.userPhone}" disabled>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-12">
									<label for="orderMessage" class="text-black">배송메시지<span
										...
										placeholder="" required value="" disabled>
								</div>
							</div>
							<div class="form-group row">
							</div>
							...
							<button type="submit" class="btn btn-black btn-lg py-3 btn-block">홈으로</button>
						</form>
					</div>
				</div>
					...
					<div class="p-3 p-lg-5 border bg-white">
						<table class="table site-block-order-table mb-5">
							...
							<tbody>
								...
								<c:forEach var="item" items="${buyListDetail}">
									<tr>
										<td>${item.itemName}</td>
										<td><fmt:formatNumber value="${item.itemPrice}" pattern="#,###" />원</td>
										<td>${item.itemCnt}</td>
										<td><fmt:formatNumber value="${item.itemPrice * item.itemCnt}" pattern="#,###" />원</td>
									</tr>
								</c:forEach>
								<tr>
									...
									<strong><fmt:formatNumber value="${buy.buyPrice}" pattern="#,###" />원</strong></td>
