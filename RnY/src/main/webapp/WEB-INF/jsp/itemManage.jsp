					...
					<table class="table">
						...
						<tbody class="justify-content-center">
							...
							<tr class="align-middle" >
								...
								<td>
										<a href="itemInfo.do?itemNo=${item.itemNo}">${item.itemNo}</a>
								</td>
								
								<td class="product-thumbnail">
									<a href="itemInfo.do?itemNo=${item.itemNo}">
									<img src="images/${item.itemImage}" alt="Image" height="50px">
									</a>
								</td>
								...
								<td><fmt:formatDate pattern="yyyy-MM-dd" value="${item.createdDate}"/></td></tr>
							</tr>
							</c:forEach>
						</tbody>
					</table>
