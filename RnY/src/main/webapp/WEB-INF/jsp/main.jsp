        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">전품목 10 ~ 20% 할인</div>
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">전품목 50% 이상 할인</div>
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">일부품목 ~ 80% 할인</div>
              ...
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">공지사항인 줄 몰랐지?</p>
                    <p class="text-black">- 관리자 김OO - </p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">출석체크 하세요!</p>
                    <p class="text-black">- 행정실 -</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">퇴실 체크 하세요!</p>
                    <p class="text-black">- 행정실 -</p>
                  </div>
                </div>
              </div>
      ...
      <div class=" swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="#"><img src="images/item5.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="#">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="#"><img src="images/item6.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="#">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">55,000원</h3>
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">1000원</h3>
